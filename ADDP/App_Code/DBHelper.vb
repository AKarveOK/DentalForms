...
#Region "DECLARATIONS"
    ...
    Private Shared ReadOnly S_CONNECTION As String = System.Configuration.ConfigurationSettings.AppSettings("DATA.CONNECTIONSTRING")
    Private Shared ReadOnly S_PROVIDER As String = System.Configuration.ConfigurationSettings.AppSettings("DATA.PROVIDER")
...
#Region "OBJECT BASED"
    ...
    Private Sub CreateDBParameters(ByVal colParameters As Object(,))
        For i As Integer = 0 To colParameters.Length \ 2 - 1
