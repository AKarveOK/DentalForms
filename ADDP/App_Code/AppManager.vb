...
Public Class AppManager
    ...
    Public Shared Sub ADDPStamp(ByVal PDFType As String, ByVal dtPat As DataTable, ByVal dtDen As DataTable, ByVal dtTooth As DataTable)
        ...
        dTotalFees = 0
        'Field 18a
        ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtTooth.Rows(0).Item("Tooth").ToString, fc8), hdrStartLeft + 38, hdrStartTop - 408, 0)
        ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(0).Item("Surface").ToString, fc8), hdrStartLeft + 64, hdrStartTop - 408, 0)
        ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(0).Item("Description").ToString, fc8), hdrStartLeft + 110, hdrStartTop - 408, 0)
        ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(0).Item("dtDosMM").ToString, fc8), hdrStartLeft + 385, hdrStartTop - 408, 0)
        ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(0).Item("dtDosDD").ToString, fc8), hdrStartLeft + 406, hdrStartTop - 408, 0)
        ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(0).Item("dtDosYY").ToString, fc8), hdrStartLeft + 423, hdrStartTop - 408, 0)
        ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(0).Item("dtCPTCode").ToString, fc8), hdrStartLeft + 452, hdrStartTop - 408, 0)
        ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtTooth.Rows(0).Item("dtCharge").ToString, fc8), hdrStartLeft + 576, hdrStartTop - 408, 0)
        dTotalFees = CDec(dtTooth.Rows(0).Item("dtCharge").ToString)

        'Field 18b
        If dtTooth.Rows.Count > 1 Then
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtTooth.Rows(1).Item("Tooth").ToString, fc8), hdrStartLeft + 38, hdrStartTop - 426, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(1).Item("Surface").ToString, fc8), hdrStartLeft + 64, hdrStartTop - 426, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(1).Item("Description").ToString, fc8), hdrStartLeft + 110, hdrStartTop - 426, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(1).Item("dtDosMM").ToString, fc8), hdrStartLeft + 385, hdrStartTop - 426, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(1).Item("dtDosDD").ToString, fc8), hdrStartLeft + 406, hdrStartTop - 426, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(1).Item("dtDosYY").ToString, fc8), hdrStartLeft + 423, hdrStartTop - 426, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(1).Item("dtCPTCode").ToString, fc8), hdrStartLeft + 452, hdrStartTop - 426, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtTooth.Rows(1).Item("dtCharge").ToString, fc8), hdrStartLeft + 576, hdrStartTop - 426, 0)
            dTotalFees = dTotalFees + CDec(dtTooth.Rows(0).Item("dtCharge").ToString)
        End If

        'Field 18c
        If dtTooth.Rows.Count > 2 Then
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtTooth.Rows(2).Item("Tooth").ToString, fc8), hdrStartLeft + 38, hdrStartTop - 445, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(2).Item("Surface").ToString, fc8), hdrStartLeft + 64, hdrStartTop - 445, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(2).Item("Description").ToString, fc8), hdrStartLeft + 110, hdrStartTop - 445, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(2).Item("dtDosMM").ToString, fc8), hdrStartLeft + 385, hdrStartTop - 445, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(2).Item("dtDosDD").ToString, fc8), hdrStartLeft + 406, hdrStartTop - 445, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(2).Item("dtDosYY").ToString, fc8), hdrStartLeft + 423, hdrStartTop - 445, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(2).Item("dtCPTCode").ToString, fc8), hdrStartLeft + 452, hdrStartTop - 445, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtTooth.Rows(2).Item("dtCharge").ToString, fc8), hdrStartLeft + 576, hdrStartTop - 445, 0)
            dTotalFees = dTotalFees + CDec(dtTooth.Rows(0).Item("dtCharge").ToString)
        End If

        'Field 18d
        If dtTooth.Rows.Count > 3 Then
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtTooth.Rows(3).Item("Tooth").ToString, fc8), hdrStartLeft + 38, hdrStartTop - 465, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(3).Item("Surface").ToString, fc8), hdrStartLeft + 64, hdrStartTop - 465, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(3).Item("Description").ToString, fc8), hdrStartLeft + 110, hdrStartTop - 465, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(3).Item("dtDosMM").ToString, fc8), hdrStartLeft + 385, hdrStartTop - 465, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(3).Item("dtDosDD").ToString, fc8), hdrStartLeft + 406, hdrStartTop - 465, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(3).Item("dtDosYY").ToString, fc8), hdrStartLeft + 423, hdrStartTop - 465, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(3).Item("dtCPTCode").ToString, fc8), hdrStartLeft + 452, hdrStartTop - 465, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtTooth.Rows(3).Item("dtCharge").ToString, fc8), hdrStartLeft + 576, hdrStartTop - 465, 0)
            dTotalFees = dTotalFees + CDec(dtTooth.Rows(0).Item("dtCharge").ToString)
        End If

        'Field 18e
        If dtTooth.Rows.Count > 4 Then
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtTooth.Rows(4).Item("Tooth").ToString, fc8), hdrStartLeft + 38, hdrStartTop - 483, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(4).Item("Surface").ToString, fc8), hdrStartLeft + 64, hdrStartTop - 483, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(4).Item("Description").ToString, fc8), hdrStartLeft + 110, hdrStartTop - 483, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(4).Item("dtDosMM").ToString, fc8), hdrStartLeft + 385, hdrStartTop - 483, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(4).Item("dtDosDD").ToString, fc8), hdrStartLeft + 406, hdrStartTop - 483, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(4).Item("dtDosYY").ToString, fc8), hdrStartLeft + 423, hdrStartTop - 483, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(4).Item("dtCPTCode").ToString, fc8), hdrStartLeft + 452, hdrStartTop - 483, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtTooth.Rows(4).Item("dtCharge").ToString, fc8), hdrStartLeft + 576, hdrStartTop - 483, 0)
            dTotalFees = dTotalFees + CDec(dtTooth.Rows(0).Item("dtCharge").ToString)
        End If

        'Field 18f
        If dtTooth.Rows.Count > 5 Then
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtTooth.Rows(5).Item("Tooth").ToString, fc8), hdrStartLeft + 38, hdrStartTop - 499, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(5).Item("Surface").ToString, fc8), hdrStartLeft + 64, hdrStartTop - 499, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(5).Item("Description").ToString, fc8), hdrStartLeft + 110, hdrStartTop - 499, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(5).Item("dtDosMM").ToString, fc8), hdrStartLeft + 385, hdrStartTop - 499, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(5).Item("dtDosDD").ToString, fc8), hdrStartLeft + 406, hdrStartTop - 499, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(5).Item("dtDosYY").ToString, fc8), hdrStartLeft + 423, hdrStartTop - 499, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(5).Item("dtCPTCode").ToString, fc8), hdrStartLeft + 452, hdrStartTop - 499, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtTooth.Rows(5).Item("dtCharge").ToString, fc8), hdrStartLeft + 576, hdrStartTop - 499, 0)
            dTotalFees = dTotalFees + CDec(dtTooth.Rows(0).Item("dtCharge").ToString)
        End If

        'Field 18g
        If dtTooth.Rows.Count > 6 Then
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtTooth.Rows(6).Item("Tooth").ToString, fc8), hdrStartLeft + 38, hdrStartTop - 518, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(6).Item("Surface").ToString, fc8), hdrStartLeft + 64, hdrStartTop - 518, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(6).Item("Description").ToString, fc8), hdrStartLeft + 110, hdrStartTop - 518, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(6).Item("dtDosMM").ToString, fc8), hdrStartLeft + 385, hdrStartTop - 518, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(6).Item("dtDosDD").ToString, fc8), hdrStartLeft + 406, hdrStartTop - 518, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(6).Item("dtDosYY").ToString, fc8), hdrStartLeft + 423, hdrStartTop - 518, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(6).Item("dtCPTCode").ToString, fc8), hdrStartLeft + 452, hdrStartTop - 518, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtTooth.Rows(6).Item("dtCharge").ToString, fc8), hdrStartLeft + 576, hdrStartTop - 518, 0)
            dTotalFees = dTotalFees + CDec(dtTooth.Rows(0).Item("dtCharge").ToString)
        End If
        ...
        'Field 18i
        If dtTooth.Rows.Count > 8 Then
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtTooth.Rows(8).Item("Tooth").ToString, fc8), hdrStartLeft + 38, hdrStartTop - 554, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(8).Item("Surface").ToString, fc8), hdrStartLeft + 64, hdrStartTop - 554, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(8).Item("Description").ToString, fc8), hdrStartLeft + 110, hdrStartTop - 554, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(8).Item("dtDosMM").ToString, fc8), hdrStartLeft + 385, hdrStartTop - 554, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(8).Item("dtDosDD").ToString, fc8), hdrStartLeft + 406, hdrStartTop - 554, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(8).Item("dtDosYY").ToString, fc8), hdrStartLeft + 423, hdrStartTop - 554, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(8).Item("dtCPTCode").ToString, fc8), hdrStartLeft + 452, hdrStartTop - 554, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtTooth.Rows(8).Item("dtCharge").ToString, fc8), hdrStartLeft + 576, hdrStartTop - 554, 0)
            dTotalFees = dTotalFees + CDec(dtTooth.Rows(0).Item("dtCharge").ToString)
        End If

        'Field 18j
        If dtTooth.Rows.Count > 9 Then
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtTooth.Rows(9).Item("Tooth").ToString, fc8), hdrStartLeft + 38, hdrStartTop - 570, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(9).Item("Surface").ToString, fc8), hdrStartLeft + 64, hdrStartTop - 570, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(9).Item("Description").ToString, fc8), hdrStartLeft + 110, hdrStartTop - 570, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(9).Item("dtDosMM").ToString, fc8), hdrStartLeft + 385, hdrStartTop - 570, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(9).Item("dtDosDD").ToString, fc8), hdrStartLeft + 406, hdrStartTop - 570, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(9).Item("dtDosYY").ToString, fc8), hdrStartLeft + 423, hdrStartTop - 570, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtTooth.Rows(9).Item("dtCPTCode").ToString, fc8), hdrStartLeft + 452, hdrStartTop - 570, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtTooth.Rows(9).Item("dtCharge").ToString, fc8), hdrStartLeft + 576, hdrStartTop - 570, 0)
            dTotalFees = dTotalFees + CDec(dtTooth.Rows(0).Item("dtCharge").ToString)
        End If
    ...
    Public Shared Sub ADDPDental(ByVal PDFType As String, ByVal dtHdr As DataTable, ByVal dtBenPlanInfo As DataTable, ByVal dtOthCvg As DataTable,
        ...
        Dim oldFile As String = "D:\NewScape\ADADentalClaimForm.pdf"
        ...
        dTotalFees = 0
        'Line 1 
        ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(0).Item("dtDos").ToString, fc10), hdrStartLeft + 29, hdrStartTop - 300, 0)
        ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(0).Item("Area").ToString, fc10), hdrStartLeft + 110, hdrStartTop - 300, 0)
        ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(0).Item("System").ToString, fc10), hdrStartLeft + 132, hdrStartTop - 300, 0)
        ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(0).Item("Number").ToString, fc10), hdrStartLeft + 152, hdrStartTop - 300, 0)
        ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(0).Item("Surface").ToString, fc10), hdrStartLeft + 242, hdrStartTop - 300, 0)
        ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(0).Item("ProcCode").ToString, fc10), hdrStartLeft + 280, hdrStartTop - 300, 0)
        ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(0).Item("DiagPointer").ToString, fc10), hdrStartLeft + 330, hdrStartTop - 300, 0)
        ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(0).Item("Qty").ToString, fc10), hdrStartLeft + 358, hdrStartTop - 300, 0)
        ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(0).Item("Description").ToString, fc10), hdrStartLeft + 388, hdrStartTop - 300, 0)
        ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtRecSvcs.Rows(0).Item("Fee").ToString, fc10), hdrStartLeft + 595, hdrStartTop - 300, 0)
        dTotalFees = CDec(dtRecSvcs.Rows(0).Item("Fee").ToString)

        'Line 2
        If dtRecSvcs.Rows.Count > 1 Then
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(1).Item("dtDos").ToString, fc10), hdrStartLeft + 29, hdrStartTop - 312, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(1).Item("Area").ToString, fc10), hdrStartLeft + 110, hdrStartTop - 312, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(1).Item("System").ToString, fc10), hdrStartLeft + 132, hdrStartTop - 312, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(1).Item("Number").ToString, fc10), hdrStartLeft + 152, hdrStartTop - 312, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(1).Item("Surface").ToString, fc10), hdrStartLeft + 242, hdrStartTop - 312, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(1).Item("ProcCode").ToString, fc10), hdrStartLeft + 280, hdrStartTop - 312, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(1).Item("DiagPointer").ToString, fc10), hdrStartLeft + 330, hdrStartTop - 312, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(1).Item("Qty").ToString, fc10), hdrStartLeft + 358, hdrStartTop - 312, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(1).Item("Description").ToString, fc10), hdrStartLeft + 388, hdrStartTop - 312, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtRecSvcs.Rows(1).Item("Fee").ToString, fc10), hdrStartLeft + 595, hdrStartTop - 312, 0)
            dTotalFees = dTotalFees + CDec(dtRecSvcs.Rows(1).Item("Fee").ToString)
        End If

        'Line 3 
        If dtRecSvcs.Rows.Count > 2 Then
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(2).Item("dtDos").ToString, fc10), hdrStartLeft + 29, hdrStartTop - 324, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(2).Item("Area").ToString, fc10), hdrStartLeft + 110, hdrStartTop - 324, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(2).Item("System").ToString, fc10), hdrStartLeft + 132, hdrStartTop - 324, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(2).Item("Number").ToString, fc10), hdrStartLeft + 152, hdrStartTop - 324, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(2).Item("Surface").ToString, fc10), hdrStartLeft + 242, hdrStartTop - 324, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(2).Item("ProcCode").ToString, fc10), hdrStartLeft + 280, hdrStartTop - 324, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(2).Item("DiagPointer").ToString, fc10), hdrStartLeft + 330, hdrStartTop - 324, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(2).Item("Qty").ToString, fc10), hdrStartLeft + 358, hdrStartTop - 324, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(2).Item("Description").ToString, fc10), hdrStartLeft + 388, hdrStartTop - 324, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtRecSvcs.Rows(2).Item("Fee").ToString, fc10), hdrStartLeft + 595, hdrStartTop - 324, 0)

            dTotalFees = dTotalFees + CDec(dtRecSvcs.Rows(2).Item("Fee").ToString)
        End If
        ...
        'Line 6 
        If dtRecSvcs.Rows.Count > 5 Then
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(5).Item("dtDos").ToString, fc10), hdrStartLeft + 29, hdrStartTop - 360, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(5).Item("Area").ToString, fc10), hdrStartLeft + 110, hdrStartTop - 360, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(5).Item("System").ToString, fc10), hdrStartLeft + 132, hdrStartTop - 360, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(5).Item("Number").ToString, fc10), hdrStartLeft + 152, hdrStartTop - 360, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(5).Item("Surface").ToString, fc10), hdrStartLeft + 242, hdrStartTop - 360, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(5).Item("ProcCode").ToString, fc10), hdrStartLeft + 280, hdrStartTop - 360, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(5).Item("DiagPointer").ToString, fc10), hdrStartLeft + 330, hdrStartTop - 360, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(5).Item("Qty").ToString, fc10), hdrStartLeft + 358, hdrStartTop - 360, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(5).Item("Description").ToString, fc10), hdrStartLeft + 388, hdrStartTop - 360, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtRecSvcs.Rows(5).Item("Fee").ToString, fc10), hdrStartLeft + 595, hdrStartTop - 360, 0)
            dTotalFees = dTotalFees + CDec(dtRecSvcs.Rows(5).Item("Fee").ToString)
        End If

        'Line 7 
        If dtRecSvcs.Rows.Count > 6 Then
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(6).Item("dtDos").ToString, fc10), hdrStartLeft + 29, hdrStartTop - 372, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(6).Item("Area").ToString, fc10), hdrStartLeft + 110, hdrStartTop - 372, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(6).Item("System").ToString, fc10), hdrStartLeft + 132, hdrStartTop - 372, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(6).Item("Number").ToString, fc10), hdrStartLeft + 152, hdrStartTop - 372, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(6).Item("Surface").ToString, fc10), hdrStartLeft + 242, hdrStartTop - 372, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(6).Item("ProcCode").ToString, fc10), hdrStartLeft + 280, hdrStartTop - 372, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(6).Item("DiagPointer").ToString, fc10), hdrStartLeft + 330, hdrStartTop - 372, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(6).Item("Qty").ToString, fc10), hdrStartLeft + 358, hdrStartTop - 372, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(6).Item("Description").ToString, fc10), hdrStartLeft + 388, hdrStartTop - 372, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtRecSvcs.Rows(6).Item("Fee").ToString, fc10), hdrStartLeft + 595, hdrStartTop - 372, 0)
            dTotalFees = dTotalFees + CDec(dtRecSvcs.Rows(6).Item("Fee").ToString)
        End If

        'Line 8 
        If dtRecSvcs.Rows.Count > 7 Then
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(7).Item("dtDos").ToString, fc10), hdrStartLeft + 29, hdrStartTop - 384, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(7).Item("Area").ToString, fc10), hdrStartLeft + 110, hdrStartTop - 384, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(7).Item("System").ToString, fc10), hdrStartLeft + 132, hdrStartTop - 384, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(7).Item("Number").ToString, fc10), hdrStartLeft + 152, hdrStartTop - 384, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(7).Item("Surface").ToString, fc10), hdrStartLeft + 242, hdrStartTop - 384, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(7).Item("ProcCode").ToString, fc10), hdrStartLeft + 280, hdrStartTop - 384, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(7).Item("DiagPointer").ToString, fc10), hdrStartLeft + 330, hdrStartTop - 384, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(7).Item("Qty").ToString, fc10), hdrStartLeft + 358, hdrStartTop - 384, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(7).Item("Description").ToString, fc10), hdrStartLeft + 388, hdrStartTop - 384, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtRecSvcs.Rows(7).Item("Fee").ToString, fc10), hdrStartLeft + 595, hdrStartTop - 384, 0)
            dTotalFees = dTotalFees + CDec(dtRecSvcs.Rows(7).Item("Fee").ToString)
        End If

        'Line 9 
        If dtRecSvcs.Rows.Count > 8 Then
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(8).Item("dtDos").ToString, fc10), hdrStartLeft + 29, hdrStartTop - 397, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(8).Item("Area").ToString, fc10), hdrStartLeft + 110, hdrStartTop - 397, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(8).Item("System").ToString, fc10), hdrStartLeft + 132, hdrStartTop - 397, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(8).Item("Number").ToString, fc10), hdrStartLeft + 152, hdrStartTop - 397, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(8).Item("Surface").ToString, fc10), hdrStartLeft + 242, hdrStartTop - 397, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(8).Item("ProcCode").ToString, fc10), hdrStartLeft + 280, hdrStartTop - 397, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(8).Item("DiagPointer").ToString, fc10), hdrStartLeft + 330, hdrStartTop - 397, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(8).Item("Qty").ToString, fc10), hdrStartLeft + 358, hdrStartTop - 397, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtRecSvcs.Rows(8).Item("Description").ToString, fc10), hdrStartLeft + 388, hdrStartTop - 397, 0)
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_RIGHT, New Phrase(dtRecSvcs.Rows(8).Item("Fee").ToString, fc10), hdrStartLeft + 595, hdrStartTop - 397, 0)
            dTotalFees = dTotalFees + CDec(dtRecSvcs.Rows(8).Item("Fee").ToString)
        End If
        ...
        ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtDiag.Rows(0).Item("DiagA").ToString, fc10), hdrStartLeft + 385, hdrStartTop - 432, 0)
            ...
            'Field 38 
            ColumnText.ShowTextAligned(canvas, Element.ALIGN_LEFT, New Phrase(dtClm.Rows(0).Item("Place").ToString, fc8), hdrStartLeft + 368, hdrStartTop - 492, 0)
